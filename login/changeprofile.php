...
if($num1>0){
   ...
   elseif($npassword==""){
    $update="UPDATE `customer_master` SET `CUSTOMER_USERNAME`='$username',`CUSTOMER_EMAIL`='$email1',`CUSTOMER_PASSWORD`='$ppassword',`FIRST_NAME`='$fname',`LAST_NAME`='$lname',`GENDER`='$gender',`DOB`='$dob',`ADDRESS`='$address',`CONTACT`='$contact' WHERE `CUSTOMER_ID`='$id'";
