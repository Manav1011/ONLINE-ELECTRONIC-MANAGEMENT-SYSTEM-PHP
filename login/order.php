...
<div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    <div class="col-9"><img class="img-fluid" src="\ONLINE ELECTRONIC MANAGEMENT SYSTEM\shopkeeper\productimages\<?php echo $image;?>" style="margin-left:0%;"></div>
                    <div class="col">
...
?>        
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $adress;?></textarea>
    <a href="changeaddress.php?id=<?php echo $cid;?>"><button type="button" class="btn btn-dark" style="width:50%; margin-left:20%; margin-top:2%">Change Adress</button></a>
  </div>
   <select>
            ...
            </div><a href="registerorder.php?cid=<?php echo $cid;?>&total=<?php echo $total;?>&cartid=<?php echo $cartid;?>&quantity1=<?php echo $quantity1?>"> <button class="btn" id="btn">CONTINUE</button></a>
        </div>
    </div>
</div>
</body>
