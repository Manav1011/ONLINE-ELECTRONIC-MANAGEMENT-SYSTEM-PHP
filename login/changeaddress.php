...
if($num1>0){
    ...
    $update="UPDATE `customer_master` SET `ADDRESS`='$address' WHERE `CUSTOMER_ID`='$id'";
   if ($query=mysqli_query($con,$update)){
       header("location:order.php?cid=$id");
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="password" class="form-control" id="phone"  name="ppassword"  value="<?php echo $row['CUSTOMER_PASSWORD'];?>" required>
				</div>
			</div>
		<div class="row gutters">
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-center">
					...
					<button type="submit" id="submit" name="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to change your address?') ">Update</button><br><br>
				</div>
			</div>
      </form>
		</div>
