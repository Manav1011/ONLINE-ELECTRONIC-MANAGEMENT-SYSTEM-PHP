...
if(isset($_POST['pay'])){
   ...
   if($num1>0){
    ...
    $html=$email;
        $_SESSION['randomotp']=rand(100000,999999);
    ...
    global $orderid;
        ...
        //    $mail->CharSet"UTF-8";
            ...
            if($mail->send()){
                header("location:paymentplusotp.php?cid=$cid&total=$total&orderid=$orderid");
          }else{
        ...
        echo smtp_mailer( $html,'subject',"Your otp is-".$_SESSION['randomotp']);
