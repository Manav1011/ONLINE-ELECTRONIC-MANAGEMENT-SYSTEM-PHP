    ...
    <div class="offcanvas-body p-0">
      <nav class="navbar-dark">
        <ul class="navbar-nav">
          ...
          <li>
            <a href="admin.php" class="nav-link px-3 active mt-3">
              <span>
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 ms-5">
          <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <h5 class="card-title fw-bold fs-4"><span class="ms-2"><?php $select2="SELECT * FROM `shopkeeper_master` WHERE SHOPKEEPER_ID='1';";
                    $query2=mysqli_query($con,$select2);
                    $num2=mysqli_num_rows($query2);
                    echo $num2;?><i class="bi bi-file-bar-graph"
                    style="font-size: 3rem;"></i></span></h5>
              <p class="card-text fw-bold fs-4">Registered Owner</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 ms-5">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <h5 class="card-title fw-bold fs-4">20<span class="ms-2"><i class="bi bi-file-bar-graph"
                    style="font-size: 3rem;"></i></span></h5>
              <p class="card-text fw-bold fs-4">Reviews</p>
            </div>
          </div>
        </div>
      </div>
