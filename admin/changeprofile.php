...
$email="SELECT `ADMIN_EMAIL` FROM `admin_master` WHERE `ADMIN_ID`='1'";
$query= mysqli_query($con,$email);
 while($row=mysqli_fetch_array($query)){
 $a=$row['ADMIN_EMAIL'];
 }
 $password="SELECT `ADMIN_PASSWORD` FROM `admin_master` WHERE `ADMIN_ID`='1'";
$query1= mysqli_query($con,$password);
 while($row=mysqli_fetch_array($query1)){
 $b=$row['ADMIN_PASSWORD'];
 }
...
if(isset($_POST['submit'])){
    ...
    $update="UPDATE `admin_master` SET `ADMIN_EMAIL`='$email1',`ADMIN_PASSWORD`='$npassword' WHERE 1";
...
<font color="white">Log out</font>
          ...
          <LI class="px-3 my-3">
            ...
            <div class="collapse" id="collapseExample">
              <div class="card card-body bg-dark text-white">
                ...
                <a href="owners.php" class="nav-link px-3 active">
  ...
  <div class="card-body">
      ...
      <h5><label for="exampleInputEmail1" class="form-label"> Change Email</label></h5>
          <input type="email" class="form-control" style="width:50%; margin-left:auto; margin-right:auto;" id="exampleInputEmail1" placeholder="Enter New Email...." name="email"  value="<?php $email2="SELECT ADMIN_EMAIL FROM `admin_master` WHERE ADMIN_ID='1'";
