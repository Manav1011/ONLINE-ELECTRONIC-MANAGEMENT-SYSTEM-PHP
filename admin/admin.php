...
<?php if($sql="select * from customer_master where CUSTOMER_USERNAME='$search'"){
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item me-3" id="signin">
              ...
              <button type="button" name="logout" class="btn btn-outline-danger" onclick="return confirm('Do you want to logout?');">
...
<font color="white">Log out</font>
        ...
        <form class="d-flex ms-auto" method="post">
          <div class="input-group ">
            <input type="text" name="search" class="form-control" placeholder="Search User" aria-label="Recipient's username"
              aria-describedby="button-addon2">
            <button class="btn btn-primary" type="submit" name="submit" id="button-addon2"><i class="bi bi-search"></i></button>
          </div>
        </form>
      ...
      <nav class="navbar-dark">
        <ul class="navbar-nav">
          <LI>
            ...
            <a href="profile.php" class="nav-link px-3 active mt-3">
