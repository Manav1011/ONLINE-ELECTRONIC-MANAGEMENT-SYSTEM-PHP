...
<font color="white">Log out</font>
  ...
  <main class="mt-5 pt-3">
      <?php 
      $select1="SELECT * FROM `customer_master` WHERE ADMIN_ID='1';";
...
?>
    <tr>
      ...
      <td>  <button type="button" class="btn btn-danger"><a href="details.php?id=<?php echo $row['CUSTOMER_ID'];?>" class="link-light"style="text-decoration:none;">View details</a></button></td>
      <td>  <button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><a href="delete.php?id=<?php echo $row['CUSTOMER_ID'];?>" class="link-light"style="text-decoration:none;">Delete Record</a></button></td>
    </tr>
