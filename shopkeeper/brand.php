...
<font color="white">Log out</font>
  ...
  <main class="mt-5 pt-3">
      <?php 
      $select1="SELECT * FROM `brand_master` WHERE SHOPKEEPER_ID='1';";
...
?>
    <tr>
      ...
      <td>  <button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><a href="deletebrand.php?id=<?php echo $row['BRAND_ID'];?>" class="link-light"style="text-decoration:none;">Delete Brand</a></button></td>
    </tr>
